...
public class MyBookingPaging {
	...
	// 총 게시글 수 입력하는 생성자
	public MyBookingPaging(int totalCount) {
	...
	public MyBookingPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public MyBookingPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public MyBookingPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	public String toString() {
		return "MyBookingPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
				+ ", totalPage=" + totalPage + ", pageCount=" + pageCount + ", startPage=" + startPage + ", endPage="
				+ endPage + ", startNo=" + startNo + ", endNo=" + endNo + ", buyerId=" + buyerId + "]";
	}
