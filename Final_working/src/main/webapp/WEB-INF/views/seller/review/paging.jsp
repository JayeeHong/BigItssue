...
<%-- 	</c:if> --%>
	...
	<li><a href="/seller/review/list?curPage=${paging.startPage-paging.pageCount}">&laquo;</a></li>
	</c:if>
	...
	<li><a href="/seller/review/list?curPage=${i }">${i }</a></li>
	</c:if>
	...
	<li><a href="/seller/review/list?curPage=${paging.startPage+paging.pageCount}">&raquo;</a></li>
	</c:if>
